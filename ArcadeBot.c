...
#pragma config(Motor,  port4,           rightFrontDrive, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           rightBackDrive, tmotorVex393_MC29, openLoop)
